                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item has-dropdown" data-nav="tin-tuc">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="${window.BASE_URL || ''}user/tin-tuc/hoi-thao-hoi-nghi.html">Hội thảo - Hội nghị</a></li>
                                <li><a href="${window.BASE_URL || ''}user/tin-tuc/thong-bao.html">Thông báo</a></li>
                                <li><a href="${window.BASE_URL || ''}user/tin-tuc/sach-tu-lieu.html">Sách - Tư liệu</a></li>
                                <li><a href="${window.BASE_URL || ''}user/tin-tuc/tieu-chuan-chat-luong.html">Tiêu chuẩn - Chất lượng</a></li>
